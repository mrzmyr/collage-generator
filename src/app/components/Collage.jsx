      ...
      <div className="collage-container">
        ...
        {(() => {
          if(this.state.generated) {
            return (
              <a className={ !this.props.images.length ? 'take-snapshot take-snapshot--disabled' : 'take-snapshot' } href="javascript:;">
                <svg width="24" height="24" viewBox="0 0 24 24"><path fill="#FFF" d="M16 11h5l-9 10-9-10h5v-11h8v11zm1 11h-10v2h10v-2z"/></svg>
              </a>
            )
          } else {
            return (
              <a onClick={this.onGenerate.bind(this)} className={ !this.props.images.length ? 'take-snapshot take-snapshot--disabled' : 'take-snapshot' } href="javascript:;">
